...
const FadeInHeading = ({ children, className = '' }) => {
...
const standardsData = [
    ...
    areas: [
      {
        ...
        artefact:
          'Physical, Cognitive, Social and Emotional Development Report (EDUC5005).',
        reflection:
        ...
        links: [
          {
            label: 'View Report',
            url: 'https://drive.google.com/file/d/1xwJ6vK9R_48vtVmt3e91HD3TkOJEyF_z/view?usp=sharing',
          },
        ],
      },
      {
        ...
        artefact:
          'Professional Development Report on Cross-Curriculum Priorities (EDUC6062).',
        reflection:
        ...
        links: [
          {
            label: 'View Report',
            url: 'https://drive.google.com/file/d/1Yltlj-S62IC99S9XhRXPKdJVswxdm7o3/view?usp=sharing',
          },
        ],
      },
    ],
    ...
    areas: [
      {
        ...
        artefact:
          'Reading Investigation (EDUC5031) and Mathematics Connection Report (EDPR5003).',
        reflection:
        ...
        links: [
          {
            label: 'View Reading Investigation',
            url: 'https://drive.google.com/file/d/1G2o4Lb3oc30TISj3mU2HOmM-NbeF6DGj/view?usp=sharing',
          },
          {
            label: 'View Mathematics Report',
            url: 'https://drive.google.com/file/d/1Ms83f8iCBzqjZMruZMWPE3CyIZHlRhiA/view?usp=sharing',
          },
        ],
      },
    ],
  },
  {
    ...
    areas: [
      {
        subtitle:
          'Focus Area 3.2 - Plan, structure and sequence learning programmes',
        artefact:
          '5-Week Science Teaching Programme using the 5E Model (EDPR5005).',
        reflection:
        ...
        links: [
          {
            ...
            url: 'https://drive.google.com/file/d/1-WCYyX3A_o_xl-Dnm6j_tXYdcEyTp-R9/view?usp=sharing',
          },
        ],
      },
    ],
        ...
        links: [
          {
            ...
            url: 'https://youtu.be/Lvx4PuUumto?si=-QpOHNvcNM6XSWCG',
          },
        ],
      },
    ],
    ...
    areas: [
      {
        ...
        artefact:
          'Investigation Report for Year 2/3 Mathematics Sequence (EDPR5001).',
        reflection:
        ...
        links: [
          {
            label: 'View Investigation Report',
            url: 'https://drive.google.com/file/d/1e-kG5bP2dL2jGIWWWI2bnrLVWgzcF5sE/view?usp=sharing',
          },
        ],
      },
      {
        ...
        artefact:
          'Individual Learning Plan and Data Analysis Report (EDUC6062).',
        reflection:
        ...
        links: [
          {
            label: 'View Data Analysis Report',
            url: 'https://drive.google.com/file/d/1EsrlXG-Z_6UWumFaDAEaaXhleG9GHBVL/view?usp=sharing',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        artefact:
          'Professional Development Plan (EDUC6062) and Assessment Data Reflection (EDPR5003).',
        reflection:
        ...
        links: [
          ...
          {
            label: 'View Data Reflection',
            url: 'https://drive.google.com/file/d/1JSTrkm1m7d-ehnjel8vOsujQxFH-w-p1/view?usp=sharing',
          },
        ],
      },
    ],
      ...
      <header className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-16 border-b border-slate-200 dark:border-slate-800">
            ...
            return (
              <div
                ...
                className={`absolute transition-opacity ${
                  isDarkMode ? 'text-indigo-400/30' : 'text-indigo-500/20'
                }`}
                style={{
                  transform: `translate(${x + floatX}px, ${
                    y + floatY
                  }px) rotate(${
                    item.rotationStart + scrollY * item.rotationSpeed
                  }deg) scale(${item.scale})`,
                  opacity: opacity,
        ...
        <div className="z-10 text-center max-w-4xl px-6">
          ...
          <p className="text-xl md:text-2xl mb-8 leading-relaxed text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            "It's not about just feeding content, it's about igniting that
            desire to discover."
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate('profile')}
              className="px-8 py-3 rounded-full bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/30"
            >
              Teacher Profile
            </button>
            <button
              onClick={() => navigate('standards')}
              className="px-8 py-3 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-medium hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors"
            >
              View Standards
            </button>
          </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <FadeInSection>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
              Damian Masters is a passionate and multifaceted educator with a
              strong foundation in teaching, multimedia, and audience
              engagement. With a background in content creation, IT, marketing,
              and music, Damian blends creativity with evidence-based pedagogy
              to create dynamic learning experiences.
            </p>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-8">
              Having completed a Post Graduate Diploma in Education, he is
              driven by a commitment to modern, student-centred teaching. His
              expertise spans both traditional and digital platforms, where he
              develops innovative strategies to support literacy, promote
...
const ProfileView = () => (
  <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto animate-in fade-in duration-500">
    <FadeInHeading className="text-4xl md:text-5xl font-extrabold mb-4">
      Teacher Profile
    </FadeInHeading>
    <p className="text-xl text-slate-600 dark:text-slate-400 mb-16">
      The educator behind the nerd.
    </p>
    ...
    <div className="space-y-16">
      <FadeInSection>
        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-slate-700 dark:text-slate-300 space-y-4 leading-relaxed">
          <p>
            I am a creative, reflective, and student-centred educator who sees
            teaching as a shared journey of discovery. Rooted in my background
            in music, multimedia, and storytelling, I aim to make learning
            memorable, meaningful, and emotionally engaging.
          </p>
          <p>
            My classroom is a space where students feel seen, safe, and inspired
            to express themselves. I value curiosity, empathy, and diversity,
            and I design learning experiences that are inclusive and hands-on.
          </p>
          <p className="font-medium text-slate-900 dark:text-white border-l-4 border-indigo-500 pl-4 my-6">
            Grounded in sociocultural and constructivist theory, I see myself as
            a guide rather than a gatekeeper—someone who walks alongside
            learners, not ahead of them.
          </p>
          <p>
            I continuously reflect on my practice, seek feedback, and embrace
            innovation to grow both professionally and personally.
          </p>
        </div>
      </FadeInSection>
      ...
      <FadeInSection delay="delay-100">
        ...
        <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
          <p>
            As an educator, my responsibility extends beyond delivering
            curriculum; it is to ignite curiosity, foster creativity, and build
            confident, compassionate learners who are equipped to thrive in a
            rapidly evolving world. I strive to create a classroom that
            celebrates diversity, encourages risk-taking, and empowers students
            to express their unique voices through storytelling, collaboration,
            and critical inquiry.
          </p>
          <p>
            With a strong foundation in computer science, multimedia, music, and
            educational psychology, I design learning experiences that are
            dynamic, differentiated, and grounded in evidence-based strategies.
            I integrate hands-on exploration, digital tools, and multimodal
            resources to support a wide range of learners.
          </p>
          <p>
            I see every moment in the classroom as an opportunity to model
            empathy, resilience, and growth. I champion student wellbeing
            alongside academic rigour, ensuring learners feel seen, supported,
            and safe to explore who they are. Through strategies like class
            discussions, storytelling, and reflective writing, I nurture both
            intellectual and emotional development.
          </p>
          <p>
            Committed to lifelong learning and professional excellence, I
            constantly reflect on my practice, seek feedback, and stay informed
            about contemporary educational approaches. This digital portfolio is
            a living document, a curated collection of lessons, student work,
            and critical reflections, showcasing my dedication to inclusive,
            innovative, and impactful teaching.
          </p>
        </div>
      </FadeInSection>
      ...
      <FadeInSection delay="delay-200">
        <h3 className="text-2xl font-bold mb-6 text-indigo-600 dark:text-indigo-400">
          Clearances & Mandatory Certifications
        </h3>
        <div className="p-8 rounded-3xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-800/50">
          <p className="text-slate-700 dark:text-slate-300 mb-6">
            As a registered teacher in Western Australia, I maintain all
            required clearances and mandatory certifications. These reflect my
            commitment to child safety, professional integrity, and the
            responsibility I carry as an educator.
          </p>
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-800 shadow-sm">
              <CheckCircle2 className="w-6 h-6 text-emerald-500 shrink-0" />
              <span className="font-bold text-slate-900 dark:text-white text-sm">
                NCCHC Police Clearance
              </span>
            </div>
            <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-800 shadow-sm">
              <CheckCircle2 className="w-6 h-6 text-emerald-500 shrink-0" />
              <span className="font-bold text-slate-900 dark:text-white text-sm">
                First Aid in Education & Care (2024)
              </span>
            </div>
          </div>
        </div>
      ...
      <FadeInSection delay="delay-300">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {[
            {
              text: 'Graduate Diploma of Education (Primary)',
              icon: GraduationCap,
            },
            ...
            {
              text: 'Certificate IV in Computer Systems Management',
              icon: Laptop,
            },
            ...
            <div
              key={i}
              className="flex items-center gap-4 p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors"
            >
  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen animate-in fade-in duration-500">
      ...
      <p className="text-center text-slate-600 dark:text-slate-400 mb-12 max-w-2xl mx-auto">
        A curated collection of reflections and pedagogical artefacts aligned
...
const ToolsView = ({ user, config, onLogin, onLogout }) => (
  <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen flex flex-col items-center animate-in fade-in duration-500">
    <div className="text-center mb-16">
      ...
      <FadeInHeading className="text-4xl md:text-5xl font-extrabold mb-6">
        Digital Tools & Ecosystem
      </FadeInHeading>
      <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
        This space is reserved for my bespoke, zero-friction educational
        applications. <br />
        <span className="font-bold text-indigo-600 dark:text-indigo-400 mt-4 block">
          Coming soon: The 'Student Check-in' and 'Multi-modal Whiteboard'.
        </span>
      </p>
    </div>

    {/* Auth & Configuration Ledger UI */}
        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm w-full">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-3">
              <Brain className="w-8 h-8 text-indigo-500" /> System Configuration
              Ledger
            </h3>
            {!user ? (
              <button
                onClick={onLogin}
                className="px-6 py-3 rounded-full bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-colors shadow-md w-full md:w-auto"
              >
                Educator SSO Login
              </button>
            ) : (
              <button
                onClick={onLogout}
                className="px-6 py-3 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors w-full md:w-auto"
              >
                Sign Out (
                {user.isAnonymous ? 'Prototype Mode' : 'Educator Mode'})
              </button>
            )}
          </div>
          ...
          {user ? (
            ...
            <div className="text-center p-12 bg-slate-50 dark:bg-slate-950/50 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700">
              <p className="text-slate-500 dark:text-slate-400 font-medium">
                Authentication required to view and synchronise the global
      ...
      <div className="p-12 md:p-24 rounded-[3rem] bg-indigo-600 dark:bg-indigo-900 relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 text-white">
          ...
          <p className="text-indigo-100 text-lg md:text-xl mb-12 max-w-2xl mx-auto font-medium">
            Whether you are a school principal seeking a dependable relief
            educator, or a parent looking to bridge the gap in your child's
            learning journey.
          </p>
          <a
            href="mailto:damian@needanerd.edu.au"
            className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-white text-indigo-900 font-bold text-lg hover:bg-slate-100 hover:scale-105 transition-all shadow-xl"
          >
...
export default function App() {
  ...
  const [config, setConfig] = useState({
    ...
    layout: {
      activeWorkspace: 'check-in',
      whiteboardToolbarPosition: 'right',
      visibleWidgets: ['roster', 'timer', 'mood-tracker'],
    },
    importedAssets: [],
  });

  // Derived state to protect visual layout parameters
  const isDarkMode = config.settings.theme === 'dark';

  // --- FIREBASE AUTHENTICATION (CANVAS & PROD READY) ---
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Strict schema path: /artifacts/{appId}/users/{userId}/user_config/main
    const docRef = doc(
      db,
      'artifacts',
      appId,
    ...
    const unsubscribe = onSnapshot(
      ...
      (snap) => {
        if (snap.exists()) {
          ...
          // Initialize schema for a new user
          const initialSchema = {
            uid: user.uid,
            settings: {
              theme: 'dark',
  ...
  useEffect(() => {
    ...
    // 1000ms debounce to prevent layout state loss without spamming the database
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.error(
        'SSO Failed. If in Canvas, this is expected due to iframe policies. Relying on prototype auth.',
        err
      );
    }
  };
  ...
  const handleLogout = async () => {
    try {
      await signOut(auth);
      // Fallback immediately to prototype mode to preserve Canvas interaction
      await signInAnonymously(auth);
    } catch (err) {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'home':
        return <HomeView navigate={navigate} isDarkMode={isDarkMode} />;
      case 'profile':
        return <ProfileView />;
      case 'standards':
  ...
  return (
    <div
      className={`font-sans transition-colors duration-500 flex flex-col min-h-screen ${
        isDarkMode
    ...
    >
      ...
      {/* Main Content Area (Routed via State + Hash) */}
      ...
      <footer className="py-12 px-6 text-center text-slate-500 dark:text-slate-500 text-sm border-t border-slate-200 dark:border-slate-800">
        ...
        <p>
          &copy; {new Date().getFullYear()} Damian Masters. All rights reserved.
        </p>
